...
from words import get_small_words, get_medium_words, get_large_words, get_huge_words, get_long_words
...
class SolverTest(unittest.TestCase):
    ...
    #     """~200 words with very long lengths - requires optimization."""
    #     words = get_long_words()
    #     wl = WordList(words)
    #     solver = Solver(wl)
    #     t0 = time.time()
    #     result = solver.find_containers()
    ...
    #     self.assertIsInstance(result, list)
    #     expected_time = 1.0
    #     self.assertLess(elapsed, expected_time, f"long words: {elapsed:.2f}s, need < {expected_time}s")
